...
*/}
  <div style={{"max-width":"600px","margin":"0 auto"}} className="email-container">
        ...
        <tr>
          <td style={{"background-color":"#E5E6E5"}}>
            <table role="presentation" cellSpacing={0} cellPadding={0} border={0} width="100%">
              <tbody><tr>
                  <td style={{"padding":"20px","font-family":"sans-serif","font-size":"15px","line-height":"20px","color":"#4E5058"}}>
                    <h1 className="new_tranaction_title" style={{"margin":"0 0 10px 0","font-family":"sans-serif","font-size":"25px","line-height":"30px","color":"#4E5058","font-weight":"bold"}}>
                      New Transactions Notification</h1>
                    <h3 style={{"margin":"0 0 10px 0","font-family":"sans-serif","font-size":"20px","line-height":"30px","color":"#4E5058","font-weight":"normal"}}>
        ...
        <tr>
          <td style={{"background-color":"#E5E6E5"}}>
            <table role="presentation" cellSpacing={0} cellPadding={0} border={0} width="100%">
              <tbody><tr>
                  <td style={{"padding":"20px","font-family":"sans-serif","font-size":"15px","line-height":"20px","color":"#4E5058"}}>
                    <h2 style={{"margin":"0 0 10px 0","font-family":"sans-serif","font-size":"18px","line-height":"22px","color":"#4E5058","font-weight":"bold"}}>
                      ACCOUNT:&nbsp;Plaid Checking.</h2>
                    <ul style={{"padding":"0","margin":"0 0 10px 0","list-style-type":"disc"}}>
                      <li style={{"margin":"0 0 10px 30px"}} className="list-item-first">
                        <span style={{"font-weight":"bold"}}>ACCOUNT_ID:</span>&nbsp;wwQeRXAwapIBjqXGkvowCaRAmwJgzbsrXe76N
                      </li>
                      <li style={{"margin":"0 0 10px 30px"}}><span style={{"font-weight":"bold"}}>ID:</span>
                        gdlLMaAdnBCaQoxE6VnjIwqjzRd1oPHgwzmnk</li>
            ...
            <table role="presentation" cellSpacing={0} cellPadding={0} border={0} width="100%">
              <tbody><tr>
                  <td style={{"padding":"20px","font-family":"sans-serif","font-size":"15px","line-height":"20px","color":"#4E5058"}}>
                    ...
                    <code style={{"margin":"0","color":"black"}}>{'{'}"error":null, "item_id":"BAygLKlAG8tKVgeLbDzJugnk7N318wU4Red6j", "new_transactions":2, "webhook_code":"DEFAULT_UPDATE", "webhook_type":"TRANSACTIONS"{'}'}</code>
                  </td>
                </tr>
              </tbody></table>
          </td>
    ...
    <table align="center" role="presentation" cellSpacing={0} cellPadding={0} border={0} width="100%" style={{"margin":"auto"}}>
      <tbody><tr>
          <td style={{"padding":"20px","font-family":"sans-serif","font-size":"12px","line-height":"15px","-webkit-text-align":"center","text-align":"center","color":"#E5E6E5"}}>
            <webversion>Go To <a style={{"color":"#E5E6E5","-webkit-text-decoration":"underline","text-decoration":"underline","font-weight":"bold"}} href="https://frankieriviera.com">FGR Budget App</a>
            </webversion>
            <br /><br />
            <webversion>Go To <a style={{"color":"#E5E6E5","-webkit-text-decoration":"underline","text-decoration":"underline","font-weight":"bold"}} href="https://frankieriviera.com">FrankieRiviera.com</a>
            </webversion>
            <br /><br />
